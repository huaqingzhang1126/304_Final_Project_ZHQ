...
# Author: Rohan Alexander, Sam Caetano and Huaqing Zhang
# Data: December 22, 2020
# Contact: rohan.alexander@utoronto.ca, huaqing.zhang@mail.utoronto.ca
# License: MIT
...
raw_data <- read_csv("AA0OUVbn.csv")
...
variable_descriptions <- as_tibble(dict) %>% 
  ...
  dplyr::rename(variable_description = value) %>% 
...
# The function sets up the regex (eh: https://xkcd.com/208/)
...
gss$education <- 
  revalue(gss$education, c("Trade certificate or diploma"=
